...
ГЛАВНОЕ ПРАВИЛО: НЕ СЖИМАЙ и НЕ ОБОБЩАЙ ответы клиента. Каждый параметр нужно расшифровать максимально подробно, структурировать и сохранить все детали, которые клиент надиктовал или написал. Если клиент сказал 5 предложений — в поле должно быть 5 предложений, а не одно обобщение.
...
Целевая аудитория.
— Структурируй по компонентам: возраст, пол, интересы, боли/проблемы, уровень дохода, география (если сказано).
— Если клиент назвал кратко (например «Мамочки») — раскрой: кто они, чего хотят, какие у них боли, что ищут в контенте.
